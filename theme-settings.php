 ...
 */
function kada_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['settings']['header_position'] = array(
    ...
    '#default_value' => theme_get_setting('header_position', 'kada'),
    '#options' => array(
      'left' => t('Left'),
      'right' => t('Right'),
    ),
  ...
  $form['settings']['font'] = array(
    '#type' => 'select',
    '#title' => t('Font'),
    '#default_value' => theme_get_setting('font', 'kada'),
    '#options' => array(
  ...
  $form['logo_includes_site_name'] = array(
    '#type' => 'checkbox',
    '#title' => t('Logo includes site name'),
    '#default_value' => theme_get_setting('logo_includes_site_name', 'kada'),
  );

  $form['hide_header_menu_for_anonymous'] = array(
    '#type' => 'checkbox',
    '#title' => t('Hide header menu for anonymous'),
    '#default_value' => theme_get_setting('hide_header_menu_for_anonymous', 'kada'),
  );
}
